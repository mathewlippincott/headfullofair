...
The first day I introduced Public Lab and mapmaking using [Grassroots Mapping Forum](http://publiclab.org/wiki/forum), and balloons using a [hot air balloon and a hair dryer](/tags/solar balloon).  The balloon set a great tone for the class. and then we set to all building [PET bottle rigs](/post/rubber-band-and-pet-bottle-camera-rig/). Much thanks to my neighbor Tasha for giving me so many soda bottles! 
